  ...
  <div class="bg-[#666361] min-h-screen w-full flex pt-16"> <!-- Agregado pt-16 para el navbar -->
    ...
    <div class="flex-1 p-8 pt-4 min-h-screen bg-[#666361]"> <!-- Cambiado pt-20 a pt-4 -->
      ...
      <div v-if="mostrarRecientes">
        ...
        <div class="w-full">
          <div class="h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-600">
            <div class="grid grid-cols-4 gap-4 p-2">
              <div v-for="project in filteredProjects" :key="project.id" class="bg-[#444] text-white rounded shadow p-3 flex flex-col gap-2 h-[120px] justify-center items-center transition-all duration-300 hover:scale-105" style="background-image: url('/fondo card.jpg'); background-size: cover; background-position: center;">
